"""
Django settings for manga_44114 project.
...
WSGI_APPLICATION = 'manga_44114.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "manga_44114 API",
    "DESCRIPTION": "API documentation for manga_44114 App",
    "VERSION": "v1",
}
